...
public class View extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		...
		viewer = new RichTextViewer(parent, SWT.BORDER);
		...
		viewer.addRichDocumentListener(new IRichDocumentListener(){
			...
			public void documentChanged(DocumentEvent event,
				...
				synchronized (updateScheduled)
				{
					if (!updateScheduled)
					{
						...
						{
							String s =viewer.getLayerManager().getSerializedString();
							browser.setText(s);
