...
public class InnerWidgetRegistry {
	protected static WeakHashMap<Composite, InnerWidgetRegistry> registry = new WeakHashMap<Composite, InnerWidgetRegistry>();
	...
	protected HashSet<Control> redrawedControls; // TODO right disposal of
													// deleted controls
