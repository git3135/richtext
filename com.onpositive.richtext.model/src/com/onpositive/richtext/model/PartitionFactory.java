...
public class PartitionFactory
{
	...
	static BasePartition createAsSample(BasePartition sample, int offset, int length)
	{
		...
		if (sample.isExpandable())
		{
			partition = sample.clone();
			...
			return new BasePartition(sample.document, offset, length);
	}
	 ...
	 */
	public static BasePartition createAsSampleStyle(BasePartition sample, ITextDocument document, int offset, int length)
	{		
